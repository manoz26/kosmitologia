  ...
  return (
    <div className="flex flex-col min-h-screen">
            ...
            <div className="glass-card p-8 md:p-10 rounded-3xl relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <ul className="space-y-3 mb-8">
                  <li className="flex items-center gap-2 text-sm text-text-secondary"><CheckCircle2 size={16} className="text-secondary"/> Συστατικά Καλλυντικών</li>
                  <li className="flex items-center gap-2 text-sm text-text-secondary"><CheckCircle2 size={16} className="text-secondary"/> Μέθοδοι Ενόργανης Ανάλυσης</li>
                  <li className="flex items-center gap-2 text-sm text-text-secondary"><CheckCircle2 size={16} className="text-secondary"/> Παρασκευή & Νομοθεσία</li>
                </ul>
              </div>
            </div>

            <div className="glass-card p-8 md:p-10 rounded-3xl relative overflow-hidden group">
              <div className="absolute top-0 right-0 w-32 h-32 bg-secondary/5 rounded-bl-full transition-transform group-hover:scale-110"></div>
              <div className="relative z-10">
      ...
      <section className="py-20 bg-primary text-white relative overflow-hidden">
        <div className="absolute inset-0 blob-green opacity-20 pointer-events-none mix-blend-screen"></div>
        <div className="section-container px-4 relative z-10">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2">
              <h2 className="font-heading text-3xl md:text-4xl font-bold mb-6">Επαγγελματικές Προοπτικές</h2>
              ...
              <ul className="space-y-4 mb-8">
                <li className="flex items-start gap-3">
                  <div className="mt-1 w-6 h-6 rounded-full bg-secondary text-white flex items-center justify-center shrink-0">✓</div>
                  <span>Παραγωγή καλλυντικών υψηλής προστιθέμενης αξίας</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="mt-1 w-6 h-6 rounded-full bg-secondary text-white flex items-center justify-center shrink-0">✓</div>
                  <span>Προώθηση καλλυντικών στην εσωτερική & διεθνή αγορά</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="mt-1 w-6 h-6 rounded-full bg-secondary text-white flex items-center justify-center shrink-0">✓</div>
                  <span>Σχεδιασμός και δημιουργία νέων, καινοτόμων σκευασμάτων</span>
                </li>
              </ul>
              <Link href="/karieres" className="inline-flex items-center gap-2 text-secondary font-bold hover:text-white transition-colors">
            ...
            <div className="lg:w-1/2 grid grid-cols-2 gap-4">
              <div className="bg-white/10 backdrop-blur-md p-6 rounded-2xl border border-white/20">
                ...
                <h4 className="font-bold text-xl mb-2">Έρευνα & R&D</h4>
                <p className="text-sm text-primary-foreground/70">Στελέχωση εργαστηρίων έρευνας νέων συστατικών.</p>
              </div>
              <div className="bg-white/10 backdrop-blur-md p-6 rounded-2xl border border-white/20 mt-8">
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-secondary mb-4"><path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>
                <h4 className="font-bold text-xl mb-2">Επιχειρηματικότητα</h4>
                <p className="text-sm text-primary-foreground/70">Ανάπτυξη δικών σας καινοτόμων brands καλλυντικών.</p>
              </div>
            </div>
          </div>
        </div>
            ...
            {[1, 2, 3].map((_, i) => (
              <Link href="/nea" key={i} className="glass-card rounded-2xl overflow-hidden group">
                <div className="h-48 bg-muted w-full relative overflow-hidden">
                  ...
                  <div className="absolute bottom-4 left-4 bg-white px-3 py-1 rounded-full text-xs font-bold text-primary">
                    ΑΝΑΚΟΙΝΩΣΗ
                  </div>
                </div>
                <div className="p-6">
